...
<title>Convert ASCII to ROT13 and vice-versa</title>
<style>
h2, h3
{
	color: yellow;
...
<br><br><br><br>
	<h2> ENCODING </h2><br>
		<form action="rot13Action.jsp" method="post">           
            <h3>Input Data:</h3>
            <br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 		    ...
 		    <select name="conversion" id="conversion">
    			...
    			<option value="ascii2rot13">ASCII to ROT13</option>
    			<option value="rot132ascii">ROT13 to ASCII </option>
    		</select>
 			 <br>
