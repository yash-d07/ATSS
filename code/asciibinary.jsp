...
<title>Convert ASCII to BINARY and vice-versa</title>
<style>
h2, h3
{
	color: yellow;
...
<body>
	<br><br><br><br>
	<h2> ENCODING </h2><br>
		<form action="asciibinaryAction.jsp" method="post">           
            <h3>Input Data:</h3>
            <br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 		    ...
 		    <select name="conversion" id="conversion">
    			...
    			<option value="ascii2hex">ASCII to BINARY numbers</option>
    			<option value="hex2ascii">BINARY to ASCII numbers</option>
    		</select>
 			 <br>
	...
	<h2> DECODING </h2><br>
		<form action="binaryasciiAction.jsp" method="post">           
            <h3>Input Data:</h3><br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 			<br>
 		    <h3> Conversion: </h3><br>
