...
<title>Convert ASCII to BASE64 and vice-versa</title>
<style>
h2, h3
{
	color: yellow;
...
<body>
	<br><br><br><br>
	<h2> ENCODING </h2><br>
		<form action="base64Action.jsp" method="post">           
            <h3>Input Data:</h3>
            <br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 		    ...
 		    <select name="conversion" id="conversion">
    			...
    			<option value="ascii2base32">ASCII to BASE64 numbers</option>
    			<option value="base32ascii">BASE64 to ASCII numbers</option>
    		</select>
 			 <br>
	...
	<h2> DECODING </h2><br>
		<form action="base64decAction.jsp" method="post">           
            <h3>Input Data:</h3><br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 			<br>
 		    <h3> Conversion: </h3><br>
