...
<br><br><br><br>
	<h2> ENCRYPTION </h2><br>
		<form action="ceaser_cipherAction.jsp" method="post">           
            <h3>Input Data:</h3>
            <br>
            ...
            <center><br><input class="input-style1" type="text" name="key" placeholder="Enter shift key" required></center>
 		    ...
 		    <select name="conversion" id="conversion">
    			...
    			<option value="ascii2ceaser">STRING to CEASER CIPHER</option>
    			<option value="ceaser2ascii">CEASER CIPHER to STRING</option>
    		</select>
 			 <br>
	...
	<h2> DECRYPTION </h2><br>
		<form action="ceaser_cipher_decAction.jsp" method="post">           
            <h3>Input Data:</h3><br>
            <input class="input-style" type="text" name="input" placeholder="Enter input text" required>
 			<br>
 			<center><br><input class="input-style1" type="text" name="key" placeholder="Enter shift key" required></center>
